...
Reportedly there are models for all states for a given year.

TO DO: Locate the annual files in the API. How far back do they go?  
Our 2020 matrix json resides in the [Open Footprint](/OpenFootprint/) "[impacts/2020](/OpenFootprint/impacts/2020)" folder.
